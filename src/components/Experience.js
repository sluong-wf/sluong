            ...
            items: [
                {
                    ...
                    description: [`Backend development on Java microservices.`]
                },
                {
                    ...
                    location: "CA (Remote)",
                    description: [`Frontend development to build Web Browser Extensions, working with service workers on React framework.`]
                },
                {
